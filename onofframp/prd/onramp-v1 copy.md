...
BB + IPL 配置（Phase 2，本期仅 BB）：
→ 展示两个选项：
   ├── BB 代收付账户（适合所有汇款人）
   └── 同名 VA 账户（专属虚拟账户，按银行区分）⚠️ Phase 2
...
| 维度               | A1：BB 直接承兑     | A2：IPL→BB→承兑 ⚠️ Phase 2 | B1：BB VA 收款→承兑        | B2：IPL VA 收款→BB→承兑 ⚠️ Phase 2 |
| ------------------ | ------------------- | ------------------------------ | --------------------------- | ------------------------------------ |
