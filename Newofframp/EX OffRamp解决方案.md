...
> **渠道基本信息、审批流程与能力维度全部拆为独立文档**：见 `渠道能力-渠道基本信息与审批流程.md`，本 Case 仅保留定位说明。

#### 5.1 整体架构（三个模块）

| 模块 | 内容 | 文档 |
| --- | --- | --- |
| **① 渠道基本信息（签约信息）** | 渠道主体、我司主体、签约有效期、渠道提供服务（法币付款 / VA 收款 / 换汇 / 人民币结汇 / 数币钱包 / 承兑）、渠道牌照、附件 | `渠道能力-渠道基本信息与审批流程.md` |
| **② 渠道能力** | 付款能力拆三类：**法币付款 / 数币付款 / 人民币结汇（外汇管制国家）** + **异常处理**（付款失败资金退回）；收款、换汇后补 | `渠道能力-渠道基本信息与审批流程.md` |
| **③ 渠道账户** | 账户维度独立于能力（法币付款的「账户要求」维度先保留）；**单独设计，本期后补** | 单独设计 |

#### 5.2 流程与审批（摘要）

- **签约 → 维护 → 变更**：FIBD 商务签约确认基本能力 → 渠道运营维护基本信息与具体能力 → 变动须走审批流并同步产品经理 / 渠道运营 / 清算（对账）/ 合规 / FIBD。
- **基本信息修改**：渠道运营修改 → **FIBD Head 审批 → 合规审批、法务审批**。
- **能力变动**：渠道运营发起 → **FIBD Head 审批** → 审批后**同步合规、产品、清算**。

#### 5.3 能力维度摘要（以独立文档为准）

- **法币付款**：收款国家（标记外汇管制，支持国家 / 禁止国家两种模式只配一种）/ **商户主体所在国家**（同样支持正反向）/ 收款方式（TT、LOCAL BANK TRANSFER、WALLET）/ **账户要求**（子账户 / 付款 VBA；VBA 仅付款或收付一体）/ 清算系统 / 行业分类 / 商户-收款人类型（B2B、B2C、C2B、C2C）/ 资金来源 / 收付款人关系 / **收款人报备开户**（需要 / 不需要，需要时填报备资料）/ 支付限额（收款方式 + Rails + 币种 + 商户-收款人类型 + 收款人类型 + 行业分类多维联动，最大最小）/ POBO / 备注；
- **数币付款**：收款方式（收款地址 / 数币钱包）/ 网络币种 / 收款地址类型 / 支付限额 / 是否支持承兑 / 备注；
- **人民币结汇（外汇管制国家）**：法币付款全部 + 申报人要求 + 贸易背景申报 + 申报备注；
- **异常处理**：付款失败资金退回（大账户 / 商户账户）/ 退回币种（渠道结算币种、收款人账户币种、付款钱包币种、自定义币种，多选）/ 退回金额（原金额 / 去掉手续费金额，附备注输入框）/ 异常备注；
- **备注规则**：基本能力、异常处理、人民币结汇申报信息 **各有独立备注字段**。

> **待确认（Case 5）**：以 `渠道能力-渠道基本信息与审批流程.md` 第七节为准。
