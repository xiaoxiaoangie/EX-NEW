...
> 节奏与通用方案 `ex-api-solution.md` §9 对齐：**Phase 0 环境 → Phase 1 前置 → Phase 2 核心业务 → Phase 3 联调 → Phase 4 上线**，最小可上线方案约 25-30 天。
...
| **Phase 1：前置流程** | 商户 KYB 审核 + 产品开通（CRYPTO_WALLET + FIAT_OFFRAMP）                                              | 3-5 天   | 7    |
| **Phase 2：核心业务** | 按场景接入（详见 6.2，可并行）                                                                        | 13-22 天 | 29   |
| **Phase 3：联调测试** | 端到端流程验证、异常场景覆盖、高 TPS 压测（针对 C 端规模）                                            | 5-7 天   | 36   |
| **Phase 4：上线**     | 生产环境切换、监控配置                                                                                | 2-3 天   | 39   |
