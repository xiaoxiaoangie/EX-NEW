...
> **核心逻辑**：
>
> - **阶段一**：商户提交入网申请，TP审核通过后，**通知商户入网成功**
> - **阶段二**：商户选择产品，系统自动SP入网，审核通过后，**通知商户产品已开通**
> - 商户全程不感知SP的存在
...
| 开通方式               | 触发者   | 触发时机                         | 适用场景         |
| ---------------------- | -------- | -------------------------------- | ---------------- |
| **商户主动开通** | 商户(MP) | 入网通过后，商户在MP选择产品     | 商户清楚业务需求 |
| **自动开通**     | 系统     | 入网通过后，根据商户资料自动开通 | 标准化业务场景   |
...
| 通知             | 触发时机           | 通知内容                             | 商户可操作 |
| ---------------- | ------------------ | ------------------------------------ | ---------- |
| **通知一** | TP审核商户资料通过 | "入网审核通过，请选择需要开通的产品" | 选择产品   |
| **通知二** | SP审核产品开通通过 | "产品已开通：数币收款、承兑服务..."  | 使用产品   |
